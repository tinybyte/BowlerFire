...
class BowlerExamplesProject(info: ProjectInfo) extends DefaultWebProject(info) with Eclipsify {
  val bowlerSqueryl = "org.bowlerframework" % "squeryl-mapper_2.8.1" % "0.3-SNAPSHOT"   withSources()
  ...
  val mavenLocal = "Local Maven Repository" at "file://E:/DEV/BUILD_TOOLS/MAVEN/.m2/repository"
